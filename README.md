...
> v0.2.0 release candidate — a lean, durable Harness with one Agent Loop, exact capabilities,
> lazy Skills/MCP, evidence-based Goal completion, and crash-safe resume.
...
After the immutable `0.2.0` npm receipt exists:
