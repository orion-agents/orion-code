...
describe('Ink UI PTY smoke', () => {
  ...
  const smokeScript = join(__dirname, '..', 'scripts', 'smoke', 'ink-ui-pty-smoke.py');
  ...
  maybeIt(
    'keeps CJK input, streaming edits, tool ordering, slash palette, and cursor anchoring stable in a real pseudo terminal',
    () => {
